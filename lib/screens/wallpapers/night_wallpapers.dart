...
class NightWallpapers extends StatelessWidget {
  const NightWallpapers({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(

        stream: FirebaseFirestore.instance.collection('Night').snapshots(),
        builder: (context,snapshot){
          ...
          return GridView.builder(
              ...
              const SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  mainAxisSpacing: 5.0,
                  mainAxisExtent: 220),
              itemCount:data.length%3==0?data.length:9,
