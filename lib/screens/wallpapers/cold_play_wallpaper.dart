...
class ColdPlayWallpapers extends StatelessWidget {
  const ColdPlayWallpapers({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(

        stream: FirebaseFirestore.instance.collection('Coldplay').snapshots(),
